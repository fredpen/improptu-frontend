        ...
        <v-row fluid align="center" justify="center">
            <v-col cols="11" class="mt-12">
                ...
                <template  v-if="isLogin" >
                    ...
                    <p @click="isLogin = false">New user? Create an account here</p>
                </template>

                <!-- register -->
                <v-card v-else class="elevatsion-12">
                    <v-toolbar color="primary" dark flat>
                    ...
                    <p @click="isLogin = true">Already a User? Sign in here</p>
                </v-card>
            </v-col>
        </v-row>
</template>
...
export default {
    ...
    data() {
        return {
            isLogin : true, items : ['male', 'female'],
        }
    },
